document.addEventListener('DOMContentLoaded', () => {
            ...
            const cargarProductos = () => {
                productosContainer.innerHTML = ''; // Limpiar el contenedor antes de recargar
                    ...
                    data.productos.forEach(producto => {
                        ...
                        productCard.innerHTML = `
                            ...
                            <div class="p-6">
                                ...
                                <button class="mt-4 w-full bg-[#7c5d4b] text-white py-2 rounded-lg font-semibold hover:bg-[#5a3e2b] transition-colors" data-product-id="${producto.id_producto}">Añadir al Carrito</button>
                            </div>
                        `;
